...
function DiagnosticWidget() {
  ...
  const handleDownloadPDF = async () => {
    ...
    const { generateDiagnosticPDF } = await import("@/lib/pdf-generator");
  ...
  if (!isOpen) {
    return (
      ...
      >
        <button
          onClick={openWidget}
          className="bg-white border border-[#B89A5A] widget-elegant hover:widget-elegant-hover transition-all duration-300 p-3 md:p-4 w-[150px] md:w-[180px] group"
        >
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed right-0 top-0 h-full w-full sm:w-[420px] bg-white widget-panel z-50 overflow-y-auto"
      >
        <div className="p-6">
...
export default function ServicesPage() {
  return (
    <main className="min-h-screen bg-[#F5F3EE] text-[#073642]">
      ...
      <section className="pt-32 pb-20 md:pb-24 px-6 lg:px-16 lg:pr-[240px]">
        <motion.div
        ...
        >
          ...
          <h1 className="font-[family-name:var(--font-sora)] text-3xl md:text-4xl lg:text-5xl uppercase leading-[1.1] mb-6 max-w-[760px]">
      ...
      <section className="pb-20 md:pb-24 px-6 lg:px-16 lg:pr-[240px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {PILIERS.map((pilier, idx) => (
              <motion.div
                ...
                className="bg-white border border-[#E5E5E5] p-6 md:p-8 hover:border-[#B89A5A] hover:shadow-[0_18px_60px_rgba(7,54,66,0.08)] transition-all duration-300 rounded-[10px]"
              >
      ...
      <section className="pb-20 md:pb-24 px-6 lg:px-16 lg:pr-[240px] bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {PRODUITS.map((produit, idx) => (
              <motion.div
                ...
                viewport={{ once: false }}
                transition={{ delay: idx * 0.1 }}
                className="bg-[#F5F3EE] border border-[#E5E5E5] p-6 hover:border-[#B89A5A] hover:shadow-[0_16px_45px_rgba(7,54,66,0.07)] transition-all duration-300 rounded-[10px]"
              >
                <div className="flex items-center justify-between mb-4">
                  <span 
                    className="font-[family-name:var(--font-manrope)] text-[9px] uppercase tracking-[0.16em] px-2 py-1 rounded-[6px]"
      ...
      <section className="pb-24 px-6 lg:px-16 lg:pr-[240px] text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="https://calendly.com/candriatiana/30min"
            target="_blank"
            className="button-elegant bg-[#073642] text-[#F3F1EC] px-8 md:px-12 font-[family-name:var(--font-manrope)] text-[10px] uppercase font-bold hover:bg-[#B89A5A] flex items-center justify-center"
          >
            Prendre RDV →
          </Link>
          <Link
            href="/diagnostic"
            className="button-elegant border border-[#B89A5A] text-[#B89A5A] px-8 md:px-12 font-[family-name:var(--font-manrope)] text-[10px] uppercase font-bold hover:bg-[#B89A5A] hover:text-[#0B0C0A]"
          >
            Faire le diagnostic
          </Link>
        </div>
