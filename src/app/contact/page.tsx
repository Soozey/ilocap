              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="bg-white border border-[#E5E5E5] p-8 rounded-sm space-y-4">
                  <input
                    ...
                    className="w-full bg-[#F5F3EE] border border-[#E5E5E5] p-4 text-[#073642] font-[family-name:var(--font-manrope)] text-sm focus:border-[#B89A5A] outline-none placeholder:text-[#073642]/60 rounded-sm"
                  />
                  <input
                    type="email"
                    placeholder="EMAIL"
                  ...
                  <textarea
                    ...
                    className="w-full bg-[#F5F3EE] border border-[#E5E5E5] p-4 text-[#073642] font-[family-name:var(--font-manrope)] text-sm focus:border-[#B89A5A] outline-none placeholder:text-[#073642]/60 resize-none rounded-sm"
                  />
                  <button
                    type="submit"
