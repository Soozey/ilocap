      ...
      <main className="bg-[#F5F2EA] text-[#173C31]">
        <section className="relative overflow-hidden px-5 pb-20 pt-36 md:px-8 md:pb-24 md:pt-44 lg:px-12">
          ...
          <div className="relative mx-auto max-w-[1320px]">
            ...
            <div className="mt-5 grid gap-8 lg:grid-cols-[1.12fr_.88fr] lg:items-end">
              ...
              <p className="max-w-xl font-[family-name:var(--font-inter)] text-base leading-7 text-[#173C31]/68 md:text-lg lg:pb-2">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {solutions.map((solution) => (
                <article
                  ...
                  className="group flex flex-col overflow-hidden rounded-[20px] border border-[#173C31]/10 bg-[#FBFCF8] transition duration-300 hover:-translate-y-1 hover:shadow-[0_22px_60px_rgba(23,60,49,.10)]"
                >
                  ...
                  <div className="flex flex-1 flex-col p-6 md:p-7">
                    ...
                    <h2 className="mt-3 font-[family-name:var(--font-source-serif)] text-3xl font-semibold leading-tight tracking-[-0.02em]">
                      {solution.name}
                    </h2>
                    <p className="mt-4 font-[family-name:var(--font-inter)] text-sm leading-6 text-[#173C31]/66 md:text-base md:leading-7">
                      {solution.cardDescription}
                    </p>
                    <div className="mt-5 flex flex-wrap gap-2">
                      {solution.proofs.slice(0, 3).map((proof) => (
                        <span key={proof.label} className="rounded-full border border-[#173C31]/10 bg-white px-3 py-2 font-[family-name:var(--font-inter)] text-xs font-medium text-[#173C31]/70">
                          {proof.value}
                        </span>
                      ))}
                    </div>
                    <Link
                      ...
                      className="mt-7 inline-flex w-fit min-h-11 items-center rounded-md border border-[#173C31]/25 px-5 font-[family-name:var(--font-inter)] text-sm font-semibold text-[#173C31] transition hover:bg-[#173C31] hover:text-white"
                    >
        ...
        <section className="bg-[#FBF9F4] py-16 md:py-20">
          <div className="mx-auto grid max-w-[1320px] gap-8 px-5 md:px-8 lg:grid-cols-[1fr_.8fr] lg:items-center lg:px-12">
            ...
            <div className="lg:justify-self-end">
              <Link
                href="/services"
                className="inline-flex min-h-11 items-center rounded-md border border-[#173C31]/25 px-5 font-[family-name:var(--font-inter)] text-sm font-semibold text-[#173C31] transition hover:bg-[#173C31] hover:text-white"
              >
        ...
        <section className="bg-[#173C31] px-5 py-20 text-white md:px-8 md:py-24 lg:px-12">
          <div className="mx-auto max-w-4xl text-center">
            <p className="font-[family-name:var(--font-inter)] text-[11px] font-semibold uppercase tracking-[0.24em] text-white/50">Une solution vous intéresse ?</p>
            ...
            <Link href="/contact?objet=demo" className="mt-8 inline-flex min-h-12 items-center rounded-md bg-[#F5F2EA] px-7 font-[family-name:var(--font-inter)] text-sm font-semibold text-[#173C31]">
